...
export default function LoginPage() {
    ...
    const handleGoogleLogin = () => {
        // Prevent multiple simultaneous requests (ref: survives re-renders; state: drives button UI)
    ...
    return (
        <AuthLayout isTyping={isTyping} password={password} showPassword={showPassword}>
            {/* Header */}
            <div className="text-center mb-10">
                <h1 className="text-3xl font-bold tracking-tight mb-2 text-gray-900">Welcome back!</h1>
                <p className="text-gray-500 text-sm">Sign in to your NexusBoard account</p>
            </div>
            ...
            <form onSubmit={handlePasswordLogin} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-sm hover:underline font-medium" style={{ color: '#e9a84c' }}>
                        Forgot password?
                    </Link>
                </div>
